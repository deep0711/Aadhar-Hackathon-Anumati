...
function RegistrationScreen( props ) {
    ...
    const [base64Icon,setIcon] = useState('https://reactnative.dev/img/tiny_logo.png');
            ...
            try {
                ...
                fetch('https://stage1.uidai.gov.in/unifiedAppAuthService/api/v2/generate/aadhaar/otp',{
                    ...
                    if(response["status"] == "Success")
                    {
                        ...
                        toast.show({
                            title: "Entered Aadhar does not exist",
                            status: "error",
                            duration: 3000,
                            variant: "outline-light"
                        });
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                />
                <Image style={{width: '100%', height: 90,marginTop:20,marginBottom:20}} source={{uri: base64Icon}}/>
                <Input 
                    variant="filled" 
